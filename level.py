...
class Level:
    ...
    def setup(self):
        tmx_data = load_pygame("main.py\\s3 - import\\data\\map.tmx")
        ...
        # water
        water_frames = import_folder('../s3 - import/graphics/water')
        ...
        Generic(
            ...
            surf=pygame.image.load(
                '../s3 - import/graphics/world/ground.png').convert_alpha(),
            groups=self.all_sprites,
            z=LAYERS['ground']
        )

    def run(self, dt):
        self.disply_surface.fill('pink')
        # self.all_sprites.draw(self.disply_surface)
